 ...
 * - SessionStart: captures session lifecycle for hook data routing
 * - Notification: captures permission_prompt and idle_prompt events
 *   (no matcher — all notification types are forwarded to the daemon
