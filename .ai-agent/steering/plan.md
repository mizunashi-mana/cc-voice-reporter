...
v1.0.0 を npm に公開済み。コア機能（transcript .jsonl 監視、音声レポート、Ollama 定期要約、マルチプロジェクト対応、対話式設定ウィザード、CLI サブコマンド体系）はすべて実装完了。フェーズ 6（品質改善・安定性）に着手予定。
...
- [ ] 要約プロンプトの構造を改善し、LLM が解析しやすくする（Issue #106）
...
- [ ] デスクトップ通知（macOS / Linux ネイティブ通知、音声と併用）
